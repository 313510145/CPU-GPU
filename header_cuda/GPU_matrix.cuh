...
class GPU_matrix: public matrix_base<T> {
    public:
        void set_size(unsigned long long rows, unsigned long long cols);
        void allocate();
        ...
        void construct_from(const T** data, unsigned long long rows, unsigned long long cols);
        void construct_from(const std::vector<T>& data, unsigned long long rows, unsigned long long cols);
        void construct_from(const std::vector<std::vector<T>>& data, unsigned long long rows, unsigned long long cols);
        void construct_from_async(cudaStream_t& stream, const T* data, unsigned long long rows, unsigned long long cols);
        void construct_from_async(cudaStream_t& stream, const T** data, unsigned long long rows, unsigned long long cols);
        void construct_from_async(cudaStream_t& stream, const std::vector<T>& data, unsigned long long rows, unsigned long long cols);
        void construct_from_async(cudaStream_t& stream, const std::vector<std::vector<T>>& data, unsigned long long rows, unsigned long long cols);
        template<typename U> friend GPU_matrix<U> add(const GPU_matrix<U>& summand, const T& addend);
        template<typename U> friend GPU_matrix<U> add(const GPU_matrix<U>& summand, const GPU_matrix<U>& addend);
        template<typename U> friend GPU_matrix<U> add_2d(const GPU_matrix<U>& summand, const T& addend);
        template<typename U> friend GPU_matrix<U> add_2d(const GPU_matrix<U>& summand, const GPU_matrix<U>& addend);
        template<typename U> friend GPU_matrix<U> add_async(cudaStream_t& stream, const GPU_matrix<U>& summand, const T& addend);
        ...
        template<typename U> friend GPU_matrix<U> add_2d_async(cudaStream_t& stream, const GPU_matrix<U>& summand, const T& addend);
        ...
        template<typename U> friend GPU_matrix<U> subtract(const GPU_matrix<U>& minuend, const T& subtrahend);
        template<typename U> friend GPU_matrix<U> subtract(const GPU_matrix<U>& minuend, const GPU_matrix<U>& subtrahend);
        template<typename U> friend GPU_matrix<U> subtract_2d(const GPU_matrix<U>& minuend, const T& subtrahend);
        template<typename U> friend GPU_matrix<U> subtract_2d(const GPU_matrix<U>& minuend, const GPU_matrix<U>& subtrahend);
        template<typename U> friend GPU_matrix<U> subtract_async(cudaStream_t& stream, const GPU_matrix<U>& minuend, const T& subtrahend);
        ...
        template<typename U> friend GPU_matrix<U> subtract_2d_async(cudaStream_t& stream, const GPU_matrix<U>& minuend, const T& subtrahend);
        ...
        template<typename U> friend GPU_matrix<U> multiply(const GPU_matrix<U>& multiplicand, const T& multiplier);
        template<typename U> friend GPU_matrix<U> multiply(const GPU_matrix<U>& multiplicand, const GPU_matrix<U>& multiplier);
        template<typename U> friend GPU_matrix<U> multiply_2d(const GPU_matrix<U>& multiplicand, const T& multiplier);
        template<typename U> friend GPU_matrix<U> multiply_2d(const GPU_matrix<U>& multiplicand, const GPU_matrix<U>& multiplier);
        template<typename U> friend GPU_matrix<U> multiply_async(cudaStream_t& stream, const GPU_matrix<U>& multiplicand, const T& multiplier);
        ...
        template<typename U> friend GPU_matrix<U> multiply_2d_async(cudaStream_t& stream, const GPU_matrix<U>& multiplicand, const T& multiplier);
